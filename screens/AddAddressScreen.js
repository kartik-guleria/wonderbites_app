              ...
              <KeyboardAvoidingView enabled>
                ...
                <View style={MainStyle.ChooseType}>
                  <View style={[MainStyle.sectionThree, {marginRight: 30}]}>
                    <Image
                      source={require('../src/images/icon_home.png')}
                  ...
                  <View style={[MainStyle.sectionThree, {marginRight: 30}]}>
                    <Image
                      source={require('../src/images/icon-office.png')}
                  ...
                  <View style={MainStyle.sectionThree}>
                    <Image
                      source={require('../src/images/icon-other.png')}
                ...
                <View
                  ...
                  <Image
                    ...
                    source={require('../src/images/RadioUnSel.png')}
                  />
